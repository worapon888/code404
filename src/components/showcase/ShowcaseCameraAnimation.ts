...
// ▶️ Enter Motion: Showcase หันซ้าย
export function animateEnterShowcase({
  camera,
  gl,
  htmlRef,
  charRefs,
  ...
  htmlRef: React.RefObject<HTMLDivElement | null>; // ✅ รองรับ null
...
// ⏹ Exit Motion (สามารถแชร์กับ About ได้)
